...
const page = () => {
  return (
    <>
     <Head>
      <title>About Decentrawood - Pioneering the AI-Powered Metaverse Experience</title>
      <meta name="description" content={`Learn about Decentrawood, the innovative AI-driven metaverse platform offering immersive games, cultural experiences, and decentralised virtual worlds. `}/>
    </Head>
