...
const PointOfInterestAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("/DAO/point-of-intrest", {
      ...
      toast.error("Error submitting proposal: " + msg);
    } finally {
      setSubmitting(false);
    }
  };
  ...
  const connectWallet = async () => {
      try {
        ...
        const message = {
          proposer: account,
          title: `Proposal to Add Point of Interest`,
          description: `Should we Add a Point of Interest ${formData.locationName}`,
          timestamp: Date.now(),
  ...
  //       type: "single-choice",
  //       title: `Add the location ${formData.locationName} to the Points of Interest`,
  ...
  return (
    <div className={styles.container}>
      ...
      <h1 className={styles.header}>Add Point of Interest</h1>
      ...
      <form className={styles.form} onSubmit={handleSubmit}>
        ...
        <div className={styles.formGroup} style={{ position: "relative" }}>
          ...
          <input
            ...
            placeholder="Enter Location Name You Want To Add"
            autoComplete="off"
            required
          />
...
export default PointOfInterestAdd;
