      ...
      <div className={`${styles.content}`}>
        <div className="container">
          <div className="row">
            <div className="col-12">
              ...
              <img src="./assets/Decentrawood_1412x130.png" className="img-fluid "/>
                {/* <div className="row">
                         <div className="col-6">
                                <p>fjgerju</p>
                         </div>
        ...
        <div className="container ">
          <div className="row my-4">
            <div className="col-12">
              <div className={`${styles.heading_dasdhboard}`}>
                <h2>Welcome to the Decentrawood NFT Marketplace</h2>
              </div>
            </div>
          </div>
          ...
          <div className="row justify-content-center my-5">
            <div className="col-md-2 col-6">
              ...
              >
                <p>PLAY AS GUEST</p>
                <img src="./assets/CollectionPacks.png" alt="" />
              </div>
            </div>
            <div
        ...
        <div className={`container ${styles.cus_dashbordcontainer}`}>
          <div className="row my-4">
            ...
            <div className="col-6">
              <Link href="/nftmarketdashboard/nft/all">
                <div className={` ${styles.title_box2}`}>
                  <p>
                    Explore All <i className="fa-solid fa-chevron-right"></i>
                  </p>
                </div>
              </Link>
            </div>
              ...
              {nftData?.map((value, key) => {
                return (
                  <div className={`card ${styles.new_card}`}>
                    ...
                    <div className={`${styles.nft_avt_img}`}>
                      <img src="./assets/nft_logo.png" alt="000" />
                    </div>
                    <div className="card-body">
                      <div className={`${styles.title_nft}`}>
                        <img src="./assets/bluetick.png" alt="" />
                        <div className={` ${styles.nft_title2}`}>
                          <p>{value?.nameOfNft}</p>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-6">
                          <div className={` ${styles.price_box_new}`}>
                            <p>{value?.price}</p>
                            <div className={` ${styles.usdprice}`}>
                              <p>{value?.USDprice} </p> <span>USD</span>
                            </div>
                          </div>
                        </div>
                        <div className="col-6">
                          <div className={` ${styles.cart_box_new}`}>
